...
Rechteck::Rechteck() : Rechteck(0, 0, 0, 0)
{}

Flaeche Rechteck::flaecheninhalt() const
{
   return _flaeche;
}

Koordinate Rechteck::x_min() const { return _x_min; }

Koordinate Rechteck::y_min() const { return _y_min; }

Koordinate Rechteck::x_max() const { return _x_max; }

Koordinate Rechteck::y_max() const { return _y_max; }

void Rechteck::set_x_min(Koordinate new_x_min) {
   _x_min = new_x_min;
   update_flaeche();
}

void Rechteck::set_x_max(Koordinate new_x_max) {
   _x_max = new_x_max;
   update_flaeche();
}

void Rechteck::update_flaeche() {
   _flaeche = (_x_max - _x_min) * (_y_max - _y_min);
}
